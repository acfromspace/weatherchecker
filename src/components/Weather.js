...
const Weather = props => (
	<div className="weather__info">
		...
		{/* COORDINATES */}
		{
			props.latitude && props.longitude && <p className="weather__key"> Coordinates:
	 		<span className="weather__value"> Lat {props.latitude}°, Lon {props.longitude}° </span>
			</p>
		}
		{/* CITY AND COUNTRY */}
		{
		...
		{/* TEMPERATURE */}
		{
			...
			{/* Second temperature is Celsius to Fahrenheit to the 2nd decimal */}
				<span className="weather__value"> {props.temperature}° C, {(props.temperature * 1.8 + 32).toFixed(2)}° F</span>
			</p>
		}
		{/* HUMIDITY */}
		{
